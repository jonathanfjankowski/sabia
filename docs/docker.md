...
> **Atenção:** compose de prod expõe 80/443 mas o nginx não tem TLS configurado.
> Antes do deploy real: usar proxy reverso (Caddy/Traefik) ou adicionar
...
Ver [arquitetura.md](arquitetura.md) (seção "Embedding sidecar") para arquitetura e troubleshooting.
