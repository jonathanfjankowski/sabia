...
Este manual explica, passo a passo, como usar cada tela do Sabiá. A documentação técnica (arquitetura, API, banco de dados) está em [arquitetura.md](arquitetura.md); instruções de instalação/deploy em [docker.md](docker.md).
